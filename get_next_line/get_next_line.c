...
static	void	clean_keep_rest(t_link_list **buf_list)
{
	t_link_list	*last;
	t_link_list	*new;
	int		i;
...
static	void	retrieve_line(t_link_list *buf_list, char **line)
{
	int	i;
	int	j;
...
static void	add_node(t_link_list **buf_list, char *buffer, int bytes_read)
{
	t_link_list	*new;
	t_link_list	*tmp;
	int		i;
...
static	void	create_list(t_link_list **buf_list, int fd)
{
	char	*buffer;
	int		bytes_read;
